...
required to run a [Timelord](https://github.com/Beer-Network/beer-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Beer-Network/beer-blockchain/blob/main/install-timelord.sh)
