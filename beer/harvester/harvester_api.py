...
from beer.plotting.plot_tools import PlotInfo, parse_plot_info
from beer.protocols import harvester_protocol
from beer.protocols.farmer_protocol import FarmingInfo
from beer.protocols.harvester_protocol import Plot
from beer.protocols.protocol_message_types import ProtocolMessageTypes
from beer.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSBeerConnection
    ):
        """
