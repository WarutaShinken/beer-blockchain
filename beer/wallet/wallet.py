...
from beer.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from beer.full_node.bundle_tools import simple_solution_generator
...
from beer.types.announcement import Announcement
...
from beer.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from beer.wallet.puzzles.puzzle_utils import (
...
from beer.wallet.secret_key_store import SecretKeyStore
from beer.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_beer(self, beer_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if beer_amount < 0:
            utxos = await self.select_coins(abs(beer_amount), exclude)
        else:
        ...
        beer_amount = spend_value + beer_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": beer_amount}]
