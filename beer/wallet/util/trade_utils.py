...
from beer.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "beer" in cc_discrepancies:
                    cc_discrepancies["beer"] = cc_discrepancies["beer"] + diff
                else:
                    cc_discrepancies["beer"] = diff
