...
from beer.consensus.network_type import NetworkType
from beer.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from beer.farmer.farmer import Farmer
from beer.protocols import farmer_protocol, harvester_protocol
from beer.protocols.harvester_protocol import PoolDifficulty
...
from beer.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSBeerConnection
    ):
        """
