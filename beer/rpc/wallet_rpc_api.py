...
from beer.cmds.init_funcs import check_keys
from beer.consensus.block_rewards import calculate_base_farmer_reward
from beer.pools.pool_wallet import PoolWallet
from beer.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from beer.protocols.protocol_message_types import ProtocolMessageTypes
from beer.server.outbound_message import NodeType, make_msg
from beer.simulator.simulator_protocol import FarmNewBlockProtocol
from beer.types.blockchain_format.coin import Coin
from beer.types.blockchain_format.sized_bytes import bytes32
from beer.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from beer.util.byte_types import hexstr_to_bytes
from beer.util.ints import uint32, uint64
from beer.util.keychain import bytes_to_mnemonic, generate_mnemonic
from beer.util.path import path_from_root
from beer.util.ws_message import WsRpcMessage, create_payload_dict
from beer.wallet.cc_wallet.cc_wallet import CCWallet
from beer.wallet.derive_keys import master_sk_to_singleton_owner_sk
from beer.wallet.rl_wallet.rl_wallet import RLWallet
from beer.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from beer.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from beer.wallet.util.trade_utils import trade_record_to_dict
from beer.wallet.util.transaction_type import TransactionType
from beer.wallet.util.wallet_types import WalletType
from beer.wallet.wallet_info import WalletInfo
from beer.wallet.wallet_node import WalletNode
from beer.util.config import load_config
...
class WalletRpcApi:
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "beer_wallet", "wallet_ui")]
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("xbr_target_address")
        pool_target = config["pool"].get("xbr_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from beer.pools.pool_wallet_info import initial_pool_state_from_dict
