...
from beer.server.server import NodeType, ssl_context_for_client
from beer.server.ssl_context import private_ssl_ca_paths
...
class RpcClient:
    """
    Client to Beer RPC, connects to a local service. Uses HTTP/JSON, and converts back from
