...
from beer.consensus.block_rewards import calculate_pool_reward
from beer.consensus.coinbase import pool_parent_id
from beer.pools.pool_wallet_info import PoolState, LEAVING_POOL, SELF_POOLING
...
from beer.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
def solution_to_extra_data(full_spend: CoinSpend) -> Optional[PoolState]:
    ...
    if num_args == 2:
        ...
        # This is referred to as p1 in the beerlisp code
