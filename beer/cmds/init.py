...
def init_cmd(ctx: click.Context, create_certs: str):
    ...
    - Get more details on remote harvester on Beer wiki:
      https://github.com/Beer-Network/beer-blockchain/wiki/Farming-on-many-machines
    """
...
if __name__ == "__main__":
    from .init_funcs import beer_init
    from beer.util.default_root import DEFAULT_ROOT_PATH

    beer_init(DEFAULT_ROOT_PATH)
