...
from beer.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "beta1_introducer.beernetwork.org"
            testnet = "testnet7"
    ...
    if change_made:
        print("Restart any running beer services for changes to take effect")
