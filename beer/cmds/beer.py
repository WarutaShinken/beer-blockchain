...
from beer.cmds.configure import configure_cmd
from beer.cmds.farm import farm_cmd
from beer.cmds.init import init_cmd
from beer.cmds.keys import keys_cmd
from beer.cmds.netspace import netspace_cmd
from beer.cmds.plots import plots_cmd
from beer.cmds.show import show_cmd
from beer.cmds.start import start_cmd
from beer.cmds.stop import stop_cmd
from beer.cmds.wallet import wallet_cmd
from beer.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage beer blockchain infrastructure ({__version__})\n",
    epilog="Try 'beer start node', 'beer netspace -d 192', or 'beer show -s'",
...
@cli.command("version", short_help="Show beer version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs beer daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from beer.daemon.server import async_run_daemon
    import asyncio
