...
if [ "$NOTARIZE" ]; then
  ...
  notarize-cli --file=$DMG_NAME --bundle-id net.beer.blockchain \
...
# xcrun altool --notarize-app -f Beer-0.1.X.dmg --primary-bundle-id net.beer.blockchain -u username -p password
