...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Beer-darwin-arm64/Beer.app --platform=darwin \
...
mv Beer-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Beer-$BEER_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Beer-darwin-arm64/Beer.app Beer-$BEER_INSTALLER_VERSION-arm64 \
