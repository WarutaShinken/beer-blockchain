...
from beer.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
from beer.protocols import full_node_protocol
from beer.protocols.full_node_protocol import RespondBlock
from beer.rpc.rpc_server import start_rpc_server
from beer.rpc.wallet_rpc_api import WalletRpcApi
from beer.rpc.wallet_rpc_client import WalletRpcClient
from beer.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
from beer.util.ints import uint16, uint32
from beer.wallet.derive_keys import master_sk_to_local_sk
...
class TestPoolWalletRpc:
    ...
    def create_pool_plot(self, p2_singleton_puzzle_hash: bytes32, shuil=None) -> bytes32:
        ...
        args.pool_contract_address = encode_puzzle_hash(p2_singleton_puzzle_hash, "txbr")
    ...
    async def test_absorb_self(self, one_wallet_node_and_rpc):
        ...
        tr: TransactionRecord = await client.send_transaction(
            1, 100, encode_puzzle_hash(status.p2_singleton_puzzle_hash, "txbr")
        )
        await time_out_assert(
            10,
            full_node_api.full_node.mempool_manager.get_spendbundle,
    ...
    async def test_absorb_pooling(self, one_wallet_node_and_rpc):
        ...
        # Balance stars at 6 XBR and 5 more blocks are farmed, total 22 XBR
    ...
    async def test_leave_pool(self, setup):
        ...
        try:
            ...
            await time_out_assert(timeout=WAIT_SECS, function=have_beer)
