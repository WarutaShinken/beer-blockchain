...
from beer.pools.pool_config import PoolWalletConfig
from beer.util.config import load_config, save_config, create_default_beer_config
...
def test_pool_config():
    ...
    create_default_beer_config(test_root, ["config.yaml"])
