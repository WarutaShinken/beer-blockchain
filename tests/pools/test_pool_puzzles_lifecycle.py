...
from beer.wallet.puzzles.p2_conditions import puzzle_for_conditions
from beer.wallet.puzzles import singleton_top_layer
from beer.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - beer.pools.pool_puzzles.py
    - beer.wallet.puzzles.pool_member_innerpuz.clvm
    - beer.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("e0695b9baaad913fe6fa5622cbe57f40ce125d13ad3f0c705581ae34248ef8f7")
