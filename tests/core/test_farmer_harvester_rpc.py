...
from beer.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from beer.protocols import farmer_protocol
from beer.rpc.farmer_rpc_api import FarmerRpcApi
from beer.rpc.farmer_rpc_client import FarmerRpcClient
from beer.rpc.harvester_rpc_api import HarvesterRpcApi
from beer.rpc.harvester_rpc_client import HarvesterRpcClient
...
from beer.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xbr"), encode_puzzle_hash(new_ph_2, "xbr"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xbr"))
            ...
            assert config["farmer"]["xbr_target_address"] == encode_puzzle_hash(new_ph, "xbr")
            assert config["pool"]["xbr_target_address"] == encode_puzzle_hash(new_ph_3, "xbr")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xbr")
