...
from beer.cmds.init_funcs import create_all_ssl, create_default_beer_config
from beer.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from beer.util.errors import Err
from beer.full_node.generator import setup_generator_args
from beer.full_node.mempool_check_conditions import GENERATOR_MOD
from beer.plotting.create_plots import create_plots
...
from beer.consensus.block_rewards import calculate_base_farmer_reward, calculate_pool_reward
from beer.consensus.blockchain_interface import BlockchainInterface
from beer.consensus.coinbase import create_puzzlehash_for_pk, create_farmer_coin, create_pool_coin
from beer.consensus.constants import ConsensusConstants
from beer.consensus.default_constants import DEFAULT_CONSTANTS
from beer.consensus.deficit import calculate_deficit
from beer.consensus.full_block_to_block_record import block_to_block_record
from beer.consensus.make_sub_epoch_summary import next_sub_epoch_summary
from beer.consensus.cost_calculator import NPCResult, calculate_cost_of_program
from beer.consensus.pot_iterations import (
    calculate_ip_iters,
...
from beer.consensus.vdf_info_computation import get_signage_point_vdf_info
from beer.full_node.signage_point import SignagePoint
from beer.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from beer.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
from beer.types.blockchain_format.pool_target import PoolTarget
from beer.types.blockchain_format.proof_of_space import ProofOfSpace
from beer.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
from beer.types.blockchain_format.sized_bytes import bytes32
from beer.types.blockchain_format.slots import (
...
from beer.types.blockchain_format.vdf import VDFInfo, VDFProof
from beer.types.condition_with_args import ConditionWithArgs
from beer.types.end_of_slot_bundle import EndOfSubSlotBundle
from beer.types.full_block import FullBlock
from beer.types.generator_types import BlockGenerator, CompressorArg
from beer.types.spend_bundle import SpendBundle
from beer.types.unfinished_block import UnfinishedBlock
from beer.types.name_puzzle_condition import NPC
from beer.util.bech32m import encode_puzzle_hash
from beer.util.block_cache import BlockCache
from beer.util.condition_tools import ConditionOpcode, conditions_by_opcode
from beer.util.config import load_config, save_config
from beer.util.hash import std_hash
from beer.util.ints import uint8, uint16, uint32, uint64, uint128
from beer.util.keychain import Keychain, bytes_to_mnemonic
from beer.util.merkle_set import MerkleSet
from beer.util.prev_transaction_block import get_prev_transaction_block
from beer.util.path import mkdir
from beer.util.vdf_prover import get_vdf_info_and_proof
from tests.wallet_tools import WalletTool
from beer.wallet.derive_keys import (
...
class BlockTools:
    ...
    def __init__(
        ...
        create_default_beer_config(root_path)
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `beer generate keys`")
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "xbr")
...
def get_plot_dir() -> Path:
    cache_path = Path(os.path.expanduser(os.getenv("BEER_ROOT", "~/.beernetwork/"))) / "test-plots"
    mkdir(cache_path)
    return cache_path
