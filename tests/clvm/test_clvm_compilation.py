...
from beer.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "beer/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "beer/wallet/puzzles/cc.clvm",
        "beer/wallet/puzzles/beerlisp_deserialisation.clvm",
        "beer/wallet/puzzles/rom_bootstrap_generator.clvm",
        "beer/wallet/puzzles/generator_for_single_coin.clvm",
        "beer/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "beer/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "beer/wallet/puzzles/lock.inner.puzzle.clvm",
        "beer/wallet/puzzles/p2_conditions.clvm",
        "beer/wallet/puzzles/p2_delegated_conditions.clvm",
        "beer/wallet/puzzles/p2_delegated_puzzle.clvm",
        "beer/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "beer/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "beer/wallet/puzzles/p2_puzzle_hash.clvm",
        "beer/wallet/puzzles/rl_aggregation.clvm",
        "beer/wallet/puzzles/rl.clvm",
        "beer/wallet/puzzles/sha256tree_module.clvm",
        "beer/wallet/puzzles/singleton_top_layer.clvm",
        "beer/wallet/puzzles/did_innerpuz.clvm",
        "beer/wallet/puzzles/decompress_puzzle.clvm",
        "beer/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "beer/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "beer/wallet/puzzles/block_program_zero.clvm",
        "beer/wallet/puzzles/test_generator_deserialize.clvm",
        "beer/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "beer/wallet/puzzles/p2_singleton.clvm",
        "beer/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "beer/wallet/puzzles/pool_member_innerpuz.clvm",
        "beer/wallet/puzzles/singleton_launcher.clvm",
        "beer/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["beer/wallet/puzzles/create-lock-puzzlehash.clvm", "beer/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "beer/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to beer/wallet/puzzles, but not added to `wallet_program_files`
        """
